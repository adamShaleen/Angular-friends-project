...
angular.module("friendList").controller('friendController', function($scope){
  // Order function
...
// function to seek out null location values and replace.
$scope.noInfo = function(array) {
    ...
    $scope.friends = $scope.noInfo($scope.friends);
})
